...
export class DanceApp extends gfx.GfxApp
{
    ...
    private myAnt: AnimatedCharacter;
    ...
    createScene(): void 
    {
        ...
        this.myAnt.position.set(0, 1, -1);
        this.myAnt.scale.multiplyScalar(0.8);
    ...
    loadSkeletons(): void
    {
        ...
        this.myAnt.loadSkeleton('./assets/data/03.asf')
    }
    ...
    loadAnimations(): void
    {
        ...
        this.myMotion = this.myAnt.loadMotionClip('./assets/data/60_03.amc');
    ...
    startAnimations(): void
    {
        ...
        this.myMotion.trimBack(100);
        this.myMotion.makeLoop(50);
        this.myMotion.makeLoop(100);
        ...
        this.balletDanceMotions[1].trimFront(100);
        this.balletDanceMotions[1].trimBack(10);

        this.balletDanceMotions[2].trimFront(500);
        this.balletDanceMotions[2].trimBack(20);

        this.balletDanceMotions[3].trimFront(450);
        this.balletDanceMotions[3].trimBack(60);

        this.balletDanceMotions[4].trimFront(100);
        this.balletDanceMotions[4].trimBack(100);
        

        this.salsaAntLead.createMeshes();
        this.salsaAntFollow.createMeshes();
        this.balletAnt.createMeshes();
        this.myAnt.createMeshes();
    ...
    toggleAxes(showAxes: boolean): void
    {
        ...
        this.myAnt.toggleAxes(showAxes);
    }
    ...
    {
        if(event.key == ' ' && this.inputnum == 0){
            this.inputnum = 1;
            this.myAnt.stop();
        }
        else if (event.key == ' ' && this.inputnum == 1){
            this.inputnum = 0;
            this.myAnt.play(this.myMotion);
        }
